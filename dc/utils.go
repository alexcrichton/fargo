...
func write(buf *bytes.Buffer, b byte) {
  b = (b << 4) | (b >> 4)
  switch b {
    case   0: buf.WriteString("/%DCN000%/")
    case   5: buf.WriteString("/%DCN005%/")
    case  36: buf.WriteString("/%DCN036%/")
    case  96: buf.WriteString("/%DCN096%/")
    case 124: buf.WriteString("/%DCN124%/")
    case 126: buf.WriteString("/%DCN126%/")
    default:  buf.WriteByte(b)
  }
}
